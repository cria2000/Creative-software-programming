	lw	0	1	0zero	load 0 to reg1 and it will store the result of 5's factorial and this is the same code as testcase2 but this make the error : not conform to the format of the label
